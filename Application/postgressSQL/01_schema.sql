...
CREATE INDEX ix_tanker_positions_timestamp_utc ON tanker_positions (timestamp_utc DESC);
CREATE INDEX ix_tanker_positions_tanker_id ON tanker_positions (tanker_id);	
...
CREATE INDEX IF NOT EXISTS idx_anomaly_flags_tanker_id
ON anomaly_flags(tanker_id);
